...
ActiveRecord::Schema[7.1].define(version: 20_240_702_074_813) do
  ...
  create_table 'follow_lists', force: :cascade do |t|
    ...
    t.index %w[follower_id followee_id], name: 'index_follow_lists_on_follower_id_and_followee_id', unique: true
