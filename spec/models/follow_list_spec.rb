...
RSpec.describe FollowList, type: :model do
  context 'validations' do
    it 'is valid with valid attributes' do
      follower = User.create(first_name: 'John', last_name: 'Doe', user_name: 'johndoe', email: 'john.doe@example.com', phone_no: '1234567890', password: 'password')
      followee = User.create(first_name: 'Jane', last_name: 'Doe', user_name: 'janedoe', email: 'jane.doe@example.com', phone_no: '0987654321', password: 'password')
